...
from envision.envision.page.budget_vs_actual.project_wise_data import project_wise_data
import frappe
...
def get_data():
    ...
    project_data = project_wise_data()
    
    return department_data, item_group_data, project_data